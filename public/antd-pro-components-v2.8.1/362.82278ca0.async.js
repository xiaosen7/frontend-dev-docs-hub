"use strict";(self.webpackChunkpro_components=self.webpackChunkpro_components||[]).push([[362],{78373:function(e,n){n.Z=`import {
  ProCard,
  ProDescriptions,
  ProForm,
  ProFormDependency,
...
`},28608:function(e,n){n.Z=`/* eslint-disable no-param-reassign */
import {
  CopyOutlined,
  DeleteOutlined,
  HeartOutlined,
...
export default Demo;
`},38185:function(e,n){n.Z=`import { LikeOutlined, UserOutlined } from '@ant-design/icons';
...
`},22735:function(e,n){n.Z=`import { PlusOutlined } from '@ant-design/icons';
import type {
  ProColumns,
...
`},72453:function(e,n){n.Z=`import { DownOutlined } from '@ant-design/icons';
import type {
  ProColumnType,
  ProFormInstance,
} from '@ant-design/pro-components';
