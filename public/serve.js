...
var require_request = __commonJS({
  "node_modules/koa/lib/request.js"(exports2, module2) {
    ...
    module2.exports = {
      ...
      get ip() {
        if (!this[IP2]) {
          this[IP2] = this.ips[0] || this.socket.remoteAddress || "";
        }
        return this[IP2];
      },
      set ip(_ip) {
...
var require_depd3 = __commonJS({
  "node_modules/koa/node_modules/depd/index.js"(exports2, module2) {
    "use strict";
    var relative2 = require("path").relative;
    module2.exports = depd2;
    var basePath2 = process.cwd();
...
var require_application = __commonJS({
  "node_modules/koa/lib/application.js"(exports2, module2) {
    ...
    var deprecate2 = require_depd3()("koa");
...
// node_modules/koa-static/node_modules/debug/src/common.js
var require_common2 = __commonJS({
  "node_modules/koa-static/node_modules/debug/src/common.js"(exports2, module2) {
    "use strict";
    function setup(env) {
      createDebug.debug = createDebug;
      createDebug.default = createDebug;
...
// node_modules/koa-static/node_modules/debug/src/browser.js
var require_browser2 = __commonJS({
  "node_modules/koa-static/node_modules/debug/src/browser.js"(exports2, module2) {
    "use strict";
...
// node_modules/koa-static/node_modules/debug/src/node.js
var require_node2 = __commonJS({
  "node_modules/koa-static/node_modules/debug/src/node.js"(exports2, module2) {
    "use strict";
    var tty = require("tty");
    var util = require("util");
    exports2.init = init;
...
// node_modules/koa-static/node_modules/debug/src/index.js
var require_src2 = __commonJS({
  "node_modules/koa-static/node_modules/debug/src/index.js"(exports2, module2) {
    "use strict";
    if (typeof process === "undefined" || process.type === "renderer" || process.browser === true || process.__nwjs) {
...
var require_koa_send = __commonJS({
  "node_modules/koa-send/index.js"(exports2, module2) {
    ...
    async function send(ctx, path2, opts = {}) {
      ...
      path2 = decode(path2);
      if (path2 === -1) return ctx.throw(400, "failed to decode");
      if (index && trailingSlash) path2 += index;
      path2 = resolvePath(root, path2);
      if (!hidden && isHidden(root, path2)) return;
      let encodingExt = "";
      ...
      if (extensions && !/\./.exec(basename2(path2))) {
      ...
      if (setHeaders) setHeaders(ctx.res, path2, stats);
      ...
      if (!ctx.type) ctx.type = type(path2, encodingExt);
...
var DEFAULT_ROOT_PORT = 4e3;
var IP = import_ip.default.address();
async function main() {
  const publicDir = process.env.NODE_ENV === "production" ? __dirname : import_path.default.join(__dirname, "../public");
  const docRoots = (0, import_fs.readdirSync)(publicDir).map((x) => import_path.default.join(publicDir, x)).filter((x) => (0, import_fs.statSync)(x).isDirectory());
  console.log("Document roots found:", docRoots);
  const ports = await serveAndGetPorts(docRoots);
  await serveRoot(docRoots, ports);
}
async function serveAndGetPorts(dirs) {
  return await Promise.all(dirs.map((x, i) => serveDir(x, i)));
}
async function serveDir(dir, index) {
  const app = new koa_default();
  app.use((0, import_koa_static.default)(dir));
  const port = await getPorts({ port: DEFAULT_ROOT_PORT + index + 1 });
  app.listen(port);
  return port;
}
async function serveRoot(dirs, ports) {
  const app = new koa_default();
  app.use((ctx) => {
    ctx.body = `
    <ul>
    ...
    ${dirs.map(
      (name, i) => `<li>
          <a onclick="navigatePort(${ports[i]})" href="javascript:void(0)">${(0, import_path.basename)(name)}</a>
        </li>
        `
    ).join("")}
    </ul>
  ...
  const port = await getPorts({ port: DEFAULT_ROOT_PORT });
  app.listen(port);
